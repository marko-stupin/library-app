...
2. Create a .env file in the backend folder and inside of it put this:
   PORT=4000__
   MONGO_URI=here put link of your mongo db database it should look like this (mongodb+srv://name:password@cluster78.sduefst.mongodb.net/) "without the ()"__
   `i excluded this file in the github repo for security reasons`__
